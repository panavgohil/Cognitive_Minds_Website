  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow text-center px-2">
        ...
        <p className="text-xs font-sans font-bold uppercase tracking-widest text-accent mb-3">{member.position}</p>
        <p className="text-sm font-sans text-secondary leading-relaxed line-clamp-3 mb-6">
          {member.description}
        </p>
        
        {/* Social Icons (Moved down here, using pure SVGs to prevent Vite errors) */}
        <div className="mt-auto flex items-center justify-center gap-5">
          <a href={member.linkedin} className="text-secondary hover:text-accent transition-colors duration-300">
          ...
          <a href={member.instagram} className="text-secondary hover:text-accent transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
